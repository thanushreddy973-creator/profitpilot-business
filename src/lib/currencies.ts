...
// Comprehensive world currency list (ISO 4217).
...
export function formatMoney(value: number, code: string, compact = false): string {
  ...
  try {
    ...
    return `${getCurrency(code).symbol} ${safe.toFixed(2)}`;
  }
}
